public static class Constants {
    ...
    public const float TILE_PADDING = 16f;
    ...
    public const float ROW_REVEAL_TIME_INITIAL = 1f;
    public const float ROW_MOVE_SPEED = 1000f;
    public const float BOARD_MOVE_SPEED = 400f;
